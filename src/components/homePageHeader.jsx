...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="w-full h-20 sticky top-0 z-50 flex items-center justify-center px-4 md:px-6 pl-24 md:pl-32 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-slate-200 shadow-sm relative">
